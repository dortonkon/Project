...
public class FourthForm extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void Play() {
        ...
        if (SP.getString(key2, "").equals("")) {
            SharedPreferences.Editor editor = SP.edit();
            editor.putString(key2, "0");
            editor.commit();
        }
        if (Integer.parseInt(SP.getString(key2, "")) < Scores) {
            SP = getSharedPreferences("save", MODE_PRIVATE);
            SharedPreferences.Editor editor = SP.edit();
            editor.putString(key2, String.valueOf(Scores));
            editor.commit();
        }
        if (SP.getString(key2, "").equals("0")) {
            record.setText("Рекорд: 0");
        } else record.setText("Рекорд: " + SP.getString(key2, ""));
        ...
        switch ((int) (Math.random() * 4)) {
            case 0:
                firstNum = (int) (Math.random() * 51);
                secondNum = (int) (Math.random() * 51);
                rez = firstNum + secondNum;
                example.setText(firstNum + " + " + secondNum + " = ");
                break;
            case 1:
                secondNum = (int) (Math.random() * 51);
                firstNum = (int) (Math.random() * (51 - secondNum) + secondNum);
                rez = firstNum - secondNum;
                example.setText(firstNum + " - " + secondNum + " = ");
                break;
            case 2:
                secondNum = (int) (Math.random() * 11);
                firstNum = (int) (Math.random() * 11);
                rez = firstNum * secondNum;
                example.setText(firstNum + " • " + secondNum + " = ");
                break;
            case 3:
                firstNum = (int) (Math.random() * 11);
                secondNum = ((int) (Math.random() * 11) + 1);
                rez = firstNum;
        ...
        for (Button but : arrBut) {
            switch ((int) (Math.random() * 2)) {
                case 0:
                    switch ((int) (Math.random() * 4)) {
                        case 0: but.setBackgroundColor(ContextCompat.getColor(this, R.color.colorRed));
                            break;
                        case 1: but.setBackgroundColor(ContextCompat.getColor(this, R.color.colorGreen));
                            break;
                        case 2: but.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPink));
                            break;
                        case 3: but.setBackgroundColor(ContextCompat.getColor(this, R.color.colorOrange));
                            break;
                    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.pause:
                ...
                i.putExtra("key", String.valueOf(2));
                startActivity(i);
                break;
    ...
    protected void scoreCount() {
        Scores += 12 + (int) (Math.random() * 13) + (int) (s / 2);
