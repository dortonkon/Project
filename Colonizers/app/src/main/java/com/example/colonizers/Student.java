...
public class Student extends AppCompatActivity implements View.OnClickListener{
    ...
    final String key4 = "ScoreStudent";
    ...
    protected void Play() {
        ...
        switch ((int) (Math.random() * 8)) {
            case 0:
                firstNum = (int) (Math.random() * 151);
                secondNum = (int) (Math.random() * 151);
                rez = firstNum + secondNum;
                example.setText(firstNum + " + " + secondNum + " = ");
                break;
            case 1:
                secondNum = (int) (Math.random() * 151);
                firstNum = (int) (Math.random() * (151 - secondNum) + secondNum);
                rez = firstNum - secondNum;
                example.setText(firstNum + " - " + secondNum + " = ");
                break;
            case 2:
                secondNum = (int) (Math.random() * 26);
                firstNum = (int) (Math.random() * 26);
                rez = firstNum * secondNum;
                example.setText(firstNum + " • " + secondNum + " = ");
                break;
            case 3:
                firstNum = (int) (Math.random() * 26);
                secondNum = ((int) (Math.random() * 26) + 1);
                rez = firstNum;
                example.setText(firstNum * secondNum + " : " + secondNum + " = ");
                break;
            case 4:
                firstNum = (int) (Math.random() * 30);
            ...
            case 6:
                switch (((int) (Math.random() * 11))+1){
                    ...
                    case 9:
                        rez=0;
                        example.setText("ctg(" + 90 +"°) = ");
                        break;
                    case 10:
                        rez=0;
                        example.setText("tg(" + 0 +"°) = ");
                        break;
                    case 11:
                        rez=0;
                        example.setText("tg(" + 180 +"°) = ");
                        break;
                }
                break;
            case 7:
                firstNum = (int) (Math.random() * 11);
                rez = firstNum*firstNum*firstNum;
                example.setText(firstNum+ "³ = ");
                break;
    ...
    protected void onPause() {
        ...
        if (lifes != 0 && !checkPause) {
            Intent i = new Intent(this, Pause.class);
            i.putExtra("key", String.valueOf(5));
            startActivity(i);
        }
    }
